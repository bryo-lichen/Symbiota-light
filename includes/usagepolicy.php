	...
	<body>
		...
		<div id="innertext">
			...
			<div style="margin:10px">
				...
				<div style="margin:10px;">
					<?php 
					echo 'Consorcio de Herbarios de Líquenes en América Latina (CHLAL)'; 
					echo '. '.date('Y').'. '; 
		    ...
		    <div style="margin:10px;">
				<ul>
					<li>
						Aunque el Consorcio de Herbarios de Líquenes en América Latina mantiene la infraestructura para compartir datos 
