...
<html>
	...
	<body>
		...
		<div id="innertext">
			...
			<h1>Directrices para el Uso Aceptable de Datos</h1><br />

			<h2>Formatos de Cita Recomendados</h2>
			<div style="margin:10px">
				Utilice uno de los siguientes formatos para citar los datos recuperados del <?php echo $defaultTitle; ?>:
				<div style="font-weight:bold;margin-top:10px;">
					Cita General:
				</div>
				<div style="margin:10px;">
