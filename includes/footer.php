	...
	<tr>
		<td id="footer"  colspan="3">
			<p style="margin:20px 100px">
				...
				//<a href="https://biokic.asu.edu/lichen-herbarium" target="_blank" title="Arizona State University Lichen Herbarium"><img src="<?php echo $CLIENT_ROOT; ?>/images/layout/logo_asu-lichen.jpg" /></a>
				...
				<a href="http://glalia.blogspot.com/" target="_blank" title="Grupo Latinoamericano de Liquen&oacute;logos"><img src="<?php echo $CLIENT_ROOT; ?>/images/layout/GLALIA-Logo.jpg" style="width:120px" /></a>
